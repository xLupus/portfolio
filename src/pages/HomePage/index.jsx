  ...
  return (
    <>
      <div className="flex justify-center items-center h-screen px-6">
        <div className="max-w-3xl w-full flex flex-col  mr-5 transition-all">
          ...
          <a href={curriculo} target='_blank' className="w-40 h-10 p-0 bg-blue-700 hover:bg-blue-600 text-white font-bold rounded-xl flex justify-center items-center cursor-pointer">
            Curriculo
          </a>
        </div>
