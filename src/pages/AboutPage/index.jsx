    ...
    <div className="flex flex-col items-center px-6">
      <div className="flex items-center gap-x-8 h-screen">
        ...
        <div className="max-w-4xl ">
          <div className='flex flex-col gap-y-2 py-5 my-5 border-y border-zinc-400 leading-8'>
            <p>
            ...
            <p>
              Atualmente tenho focado em aprofundar minhas habilidades como Front-end, por isso venho me aprofundando em TailwindCSS e no ecosistema Javascript.
            </p>
