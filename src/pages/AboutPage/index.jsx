      ...
      <div className="flex items-center gap-x-8 h-screen">
        ...
        <div className="max-w-4xl ">
          <div className="grid grid-cols-2 gap-4 font-bold">
            ...
            <span>IDADE: <span className='font-normal'>22</span></span>
          ...
          <div className="flex items-center gap-x-3 ">
            <a href="mailto:vinicius.as.dev@outlook.com">
            ...
            <a href="https://github.com/xLupus" target='_blank'>
            ...
            <a href="https://www.linkedin.com/in/vinicius-as-dev/" target='_blank'>
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-linkedin text-blue-700" viewBox="0 0 16 16">
